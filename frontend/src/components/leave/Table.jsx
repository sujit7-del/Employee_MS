...
const Table = () => {
  ...
  const fetchLeaves = async () => {
    try {
      const responnse = await axios.get("https://employee-ms-server-eomf.onrender.com/api/leave", {
        headers: {
        ...
        <div className="p-9 flex flex-col h-screen bg-[linear-gradient(to_bottom,_#2563eb,_#ffffff,_#2563eb)] space-y-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="space-x-3">
              <button className="px-2 py-1 bg-blue-600 text-white hover:bg-teal-700"
